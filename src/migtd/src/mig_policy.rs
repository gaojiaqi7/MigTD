...
use policy::{v1::verify_policy, v2::get_engine_svn_from_map};
use scroll::Pread;
...
pub mod v2 {
    ...
    use crate::{
        ...
        event_log,
        mig_policy::{self, check_td_report},
    };
...
pub fn read_servtd_ext() -> Result<ServtdExt, PolicyError> {
    ...
    let report =
        tdx_tdcall::tdreport::tdcall_report(&[0u8; 64]).map_err(|_| PolicyError::FailGetReport)?;
    servtd_ext
