...
impl EngineSvnMap {
    ...
    pub fn get_engine_svn(&self, mrtd: &[u8], rtmr0: &[u8]) -> Option<u32> {
        self.engine_svn.iter().find_map(|engine| {
            if engine.mrtd.as_bytes() == mrtd && engine.rtmr.as_bytes() == rtmr0 {
                Some(engine.svn)
            } else {
                None
            }
...
mod test {
    ...
    fn test_get_engine_svn() {
        ...
        let rtmr = b"abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890";
        assert_eq!(engine.get_engine_svn(mrtd, rtmr), Some(1));

        let mrtd = b"01234567890abcdef1234567890abcdef1234567890abcdef1234567890abcde";
        let rtmr = b"bcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890a";
        assert!(engine.get_engine_svn(mrtd, rtmr).is_none());
    }
    ...
    fn test_gen_policy() {
        ...
        policy.sign_engine(signing_key).unwrap();
        ...
        let mut engine = EngineSvnMap {
            engine_svn: vec![EngineSvn {
                mrtd: "1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"
                    .to_string(),
                rtmr: "abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890"
                    .to_string(),
                svn: 1,
            }],
            signature: String::new(),
